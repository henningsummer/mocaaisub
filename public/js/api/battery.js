(function() {
    ...
    function readBattery(b) {
        ...
        document.styleSheets[2].insertRule('.battery:before{width:' + percentage + '}', 0);
        document.querySelector('.battery-percentage').innerHTML = percentage;
        document.querySelector('.battery-status').innerHTML = battery.charging ? 'Carregando' : 'Descarregando';
        document.querySelector('.battery-percentage').style.color = battery.charging ? "#006400" : "#8B0000";
        //document.querySelector('.battery-card').style.background = battery.charging ? "#40E0D0" : "#F08080";
       ...
       // document.querySelector('.battery-remaining').innerHTML = remaining;
        ...
        document.getElementById('BatStatus').value = percentage;
        document.getElementById('NivelStatus').value = battery.charging ? 'Carregando' : 'Descarregando';
